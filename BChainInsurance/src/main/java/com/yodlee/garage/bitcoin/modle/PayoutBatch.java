package com.yodlee.garage.bitcoin.modle;
...
import com.yodlee.garage.bitcoin.utils.DateDeserializer;
import com.yodlee.garage.bitcoin.utils.DateSerializer;
...
public class PayoutBatch {
    ...
    @JsonProperty("currency")
	public void setCurrency(String _currency) throws PayException {
        if (_currency.length() != 3)
        {
            throw new PayException("Error: currency code must be exactly three characters");
        }
