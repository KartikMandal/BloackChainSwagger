package com.yodlee.garage.bitcoin.controller;
...
import com.yodlee.garage.bitcoin.modle.*;
...
public class BitPay {
     ...
     * @throws PayException
     */
    public BitPay(String clientName, String envUrl) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error: failed to intialize public/private key pair\n" + e.getMessage());
        } catch (URISyntaxException e) {
            e.printStackTrace();
            throw new PayException("Error: " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public BitPay(String clientName) throws PayException {
     ...
     * @throws PayException
     */
    public BitPay() throws PayException {
     ...
     */
    public BitPay(URI privateKey) throws PayException, URISyntaxException, IOException {
     ...
     * @throws PayException, IOException
     */
    public BitPay(URI privateKey, String clientName) throws PayException, IOException, URISyntaxException {
     ...
     * @throws PayException, IOException
     */
    public BitPay(URI privateKey, String clientName, String envUrl) throws PayException, IOException, URISyntaxException {
     ...
     * @throws PayException
     */
    public BitPay(ECKey ecKey, String clientName, String envUrl) throws PayException {
    	_ecKey = ecKey;
     ...
     * @throws PayException
     */
    public BitPay(ECKey ecKey, String clientName) throws PayException {
     ...
     * @throws PayException
     */
    public BitPay(ECKey ecKey) throws PayException {
     ...
     * @throws PayException
     */
    public void authorizeClient(String pairingCode) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to serialize Token object : " + e.getMessage());
        }
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Tokens) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Tokens) : " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public String requestClientAuthorization(String facade) throws PayException {
        Token token = new Token();
        token.setId(_identity);
        token.setGuid(this.getGuid());
        ...
        try {
            ...
            if (tokens.size() != 1) {
                throw new PayException("Error - failed to get token resource; expected 1 token, got " + tokens.size());
            }
     ...
     * @throws PayException
     */
    public Invoice createInvoice(Invoice invoice, String token) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to serialize Invoice object : " + e.getMessage());
        }
        ...
        if(response.getStatusLine().getStatusCode() == 500){
        	invoice.setId("10000");
        	invoice.setBtcDue(invoice.getBtcDue());
        	invoice.setBtcPaid(invoice.getBtcPaid());
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Invoice) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Invoice) : " + e.getMessage());
        }
        }
     ...
     * @throws PayException
     */
    public Invoice createInvoice(Invoice invoice) throws PayException {
     ...
     * @throws PayException
     */
    public Invoice getInvoice(String invoiceId) throws PayException {
     ...
     * @throws PayException
     */
    public Invoice getInvoice(String invoiceId, String token) throws PayException {
     ...
     * @throws PayException
     */
    public List<Invoice> getInvoices(String dateStart, String dateEnd) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Invoices) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Invoices) : " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public RefundHelper requestRefund(String invoiceId, String bitcoinAddress) throws PayException {
     ...
     * @throws PayException
     */
    public RefundHelper requestRefund(Invoice invoice, String bitcoinAddress, Double amount, String currency) throws PayException {
        if (bitcoinAddress == null && !invoice.getFlags().getRefundable()) {
            throw new PayException("Error - cannot refund an invoice without a refund address");
        }
        ...
        try {
            ...
            throw new PayException("Error - failed to serialize Refund object : " + e.getMessage());
        }
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Refund) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Refund) : " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public boolean cancelRefundRequest(String invoiceId, String refundId) throws PayException {
        Invoice invoice = this.getInvoice(invoiceId, this.getAccessToken(FACADE_MERCHANT));
     ...
     * @throws PayException
     */
    public boolean cancelRefundRequest(Invoice invoice, String refundId) throws PayException {
        Refund refund = this.getRefund(invoice, refundId);
        if (refund == null) {
            throw new PayException("Error - refundId is not associated with specified invoice");
        }
     ...
     * @throws PayException
     */
    public Refund getRefund(Invoice invoice, String refundId) throws PayException {
        Refund refund = new Refund();
     ...
     * @throws PayException
     */
    public List<Refund> getAllRefunds(Invoice invoice) throws PayException {
        List<Refund> refunds;
        final List<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();
        params.add(new BasicNameValuePair("token", invoice.getToken()));
     ...
     * @throws PayException
     */
    public Rates getRates() throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Rates) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Rates) : " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public PayoutBatch submitPayoutBatch(PayoutBatch batch) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to serialize PayoutBatch object : " + e.getMessage());
        }
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (PayoutBatch) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (PayoutBatch) : " + e.getMessage());
        }
     ...
     * @throws PayException
     */
    public List<PayoutBatch> getPayoutBatches() throws PayException {
     ...
     * @throws PayException
     */
    public PayoutBatch getPayoutBatch(String batchId) throws PayException {
        String token = this.getAccessToken(FACADE_PAYROLL);
        final List<BasicNameValuePair> params = new ArrayList<BasicNameValuePair>();
        params.add(new BasicNameValuePair("token", token));
     ...
     * @throws PayException
     */
    public PayoutBatch cancelPayoutBatch(String batchId) throws PayException {    	
    ...
    private Hashtable<String, String> responseToTokenCache(HttpResponse response) throws PayException {
        ...
        try {
            ...
            throw new PayException("Error - failed to deserialize BitPay server response (Token array) : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to deserialize BitPay server response (Token array) : " + e.getMessage());
        }
    ...
    private boolean tryGetAccessTokens() throws PayException {
    ...
    private int getAccessTokens() throws PayException {
        this.clearAccessTokenCache();
    ...
    public HttpResponse get(String uri, List<BasicNameValuePair> parameters) throws PayException {
        return get(uri, parameters, true);
    }

    public HttpResponse get(String uri, List<BasicNameValuePair> parameters, boolean signatureRequired) throws PayException {
        try {
            ...
            throw new PayException("Error: GET failed\n" + e.getMessage());
    ...
    public HttpResponse get(String uri) throws PayException {
        return this.get(uri, null, false);
    }

    public HttpResponse post(String uri, String json, boolean signatureRequired) throws PayException {
        try {
            ...
            throw new PayException("Error: POST failed\n" + e.getMessage());
        } catch (ClientProtocolException e) {
            throw new PayException("Error: POST failed\n" + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error: POST failed\n" + e.getMessage());
    ...
    public HttpResponse post(String uri, String json) throws PayException {
        return this.post(uri, json, false);
    }

    public HttpResponse postWithSignature(String uri, String json) throws PayException {
        return this.post(uri, json, true);
    }

    private HttpResponse delete(String uri, List<BasicNameValuePair> parameters) throws PayException {
        try {
            ...
            throw new PayException("Error: DELETE failed\n" + e.getMessage());
        } catch (ClientProtocolException e) {
            throw new PayException("Error: DELETE failed\n" + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error: DELETE failed\n" + e.getMessage());
    ...
    public String responseToJsonString(HttpResponse response) throws PayException {
        if (response == null) {
            throw new PayException("Error: HTTP response is null");
        }
        ...
        try {
            ...
            if (node != null) {
                throw new PayException("Error: " + node.asText());
            }
            ...
            throw new PayException("Error - failed to retrieve HTTP response body : " + e.getMessage());
        } catch (JsonMappingException e) {
            throw new PayException("Error - failed to parse json response to map : " + e.getMessage());
        } catch (IOException e) {
            throw new PayException("Error - failed to retrieve HTTP response body : " + e.getMessage());
        }
    }
